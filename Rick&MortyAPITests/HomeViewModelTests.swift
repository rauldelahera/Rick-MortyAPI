...
final class HomeViewModelTests: XCTestCase {
    ...
    func testPerformSearch() {
        ...
        //... we can fulfill the expectation so that the test can continue after L55 below, and store the results we get back in `publishedResults` so that we can use it in an assertion
